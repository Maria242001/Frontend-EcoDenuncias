...
function ListadoDenuncia() {
  ...
  const filtradas = denuncias.filter(
    (d) =>
      d.radicado.toLowerCase().includes(busqueda.toLowerCase()) ||
      d.denunciante.toLowerCase().includes(busqueda.toLowerCase()) ||
      d.municipio.toLowerCase().includes(busqueda.toLowerCase()) ||
      d.estado.toLowerCase().includes(busqueda.toLowerCase())
  );

  // 🔹 Función para ir al detalle
  const verDetalle = (radicado) => {
    alert(`Mostrando detalle de la denuncia: ${radicado}`);
  };

  // 🔹 Función para regresar a la página principal
  const regresar = () => {
    navigate("/denuncia"); // Va a la ruta principal (Denuncia)
  };
    ...
    >
      ...
      >
        ...
        <input
          ...
          placeholder="Buscar por Radicado, Denunciante, Municipio, Estado..."
          value={busqueda}
